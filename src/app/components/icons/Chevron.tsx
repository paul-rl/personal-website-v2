...
export default function Chevron({
  ...
  const flip = direction === "right" ? "scale(-1,1) translate(-100,0)" : undefined;
  ...
  return (
    <svg
      ...
      className={`group inline-block select-none outline-none 
    ...
    >
      ...
      <g transform={flip}>
        <path d={d} stroke="url(#chev-gold)" strokeWidth={stroke} strokeLinejoin="miter" strokeLinecap="square" fill="none" />
        <path
          d={d}
          stroke="url(#chev-gold-hover)"
          strokeWidth={stroke}
          strokeLinejoin="miter"
          strokeLinecap="square"
          fill="none"
          className="opacity-0 transition-opacity duration-150 ease-out group-hover:opacity-100 group-active:opacity-100"
        />
        <path d={d} stroke="var(--button, #0b1620)" strokeWidth={innerStroke} strokeLinejoin="miter" strokeLinecap="square" fill="none" />
      </g>
    </svg>
  );
}
